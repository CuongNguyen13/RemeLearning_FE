...
import type { VocabAttemptQuestionResult } from "@/types/api"
...
export function VocabResultPanel({ accuracy, results, actionAdvice, onRetry }: VocabResultPanelProps) {
          ...
          >
            ...
            {!result.correct && (
              <p className="pl-6 text-muted-foreground">
                {t("learn.vocabulary.yourAnswerWas", { answer: result.yourAnswer || t("learn.vocabulary.noAnswer") })}
              </p>
            )}
            <p className="pl-6 font-medium text-foreground">
              {t("learn.vocabulary.correctAnswerIs", { answer: result.correctAnswer })}
